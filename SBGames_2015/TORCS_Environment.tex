...
\subsection{The SCRC}
	...
	The Simulated Car Racing Championship (SCRC)~\cite{SCRC} is an example of a well-known competition which utilizes
	...
	earlier on this section.\toDo{colocar imagens ilustrativas}
