...
\subsection{Methodology} \label{subsec:Methodology}
	...
	one separately\toDo{, tornar claro que each one refere aos modelos, nao aos parametros}, in order to adjust their configurations for superior and competitive status. At the same time, the
