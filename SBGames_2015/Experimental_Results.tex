...
\toDo{TABLE DOES NOT FIT IN A SINGLE COLUMN!}
	...
	\toDo{needs review}
	In order to have a more in-depth comparison \ref{tbl:time raced road} and \ref{tbl:time raced dirt} were built displaying the time elapsed for 10 laps for each of the previous tracks tested. The \itshape{Berniw Hist4} bot provided by the TORCS distribution was also used. \toDo{mention SCRC?}
