...
\subsection{Methodology} \label{subsec:Methodology}
	...
	\toDo{As the stuck state is only triggred in very specific situations it was not evolved with the controller. It's parameters were hand tunned. (mention evolving stuck state separatedly in future wokrs?)}
	
	\toDo{The learning module was turned off during evolution so it does not interfer in the parameters choice.}
