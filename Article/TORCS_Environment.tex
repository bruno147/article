...
\subsection{TORCS as platform, interface and environment}
	...
	research platform, for it provides (\toDo{não sei o torcs dá alguma coisa ou não}) a complete sensor-based interaction system in which the developer is able to
	...
	characteristic of any real-life problem simulation, what in academia is denominated \emph{reality gap}\toDo{referencia}, and it
...
\subsection{The SCRC}
	...
	presented earlier on this section.\toDo{colocar imagens ilustrativas}
